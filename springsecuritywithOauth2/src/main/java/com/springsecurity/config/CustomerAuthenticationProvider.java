 ...
 * 
 * import com.springsecurity.model.Authority; import
 * com.springsecurity.model.Customer; import
 * com.springsecurity.repo.CustomerRepo;
 * 
 * 
 * @Component public class CustomerAuthenticationProvider implements
 ...
 * 
 * System.out.println(customer.toString()); if(customer.size()>0) {
 ...
 * getGrantedAuthorities(customer.get(0).getAuthorities())); } else { throw new
 * BadCredentialsException("Invalid Password"); } } else { throw new
 * BadCredentialsException("No User Registered With Details"); } }
 * 
